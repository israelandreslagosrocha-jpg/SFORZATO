...
export const Button: React.FC<ButtonProps> = ({
  ...
  const sizeStyles = {
    sm: 'text-xs px-4 sm:px-5 py-2.5 tracking-wider uppercase font-bold',
    md: 'text-xs sm:text-sm px-5 sm:px-6 py-3 sm:py-3.5 tracking-wider sm:tracking-widest uppercase font-bold',
    lg: 'text-xs sm:text-sm md:text-base px-5 sm:px-8 py-3.5 sm:py-4 tracking-wider sm:tracking-widest uppercase font-bold',
  };
