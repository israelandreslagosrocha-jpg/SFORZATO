    ...
    <SectionContainer id="album" className="py-24 sm:py-32 border-t border-black/5 relative">
      ...
      <div className="max-w-5xl mx-auto flex flex-col gap-12 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          ...
          <div className="glass-card rounded-2xl p-6 sm:p-8 flex flex-col justify-between gap-6 group shadow-sm">
            ...
            <div>
              ...
              <span className="text-xs text-slate-600 font-light mt-1 block">
          ...
          <div className="glass-card rounded-2xl p-6 sm:p-8 flex flex-col justify-between gap-6 group shadow-sm">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[10px] font-mono text-[var(--color-accent-gold)] bg-[var(--color-accent-gold)]/10 px-2 py-0.5 rounded-full border border-[var(--color-accent-gold)]/20 font-semibold">
                HI-RES
              </span>
            </div>
            <div>
        ...
        <div className="glass-card rounded-3xl p-8 sm:p-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 border-l-4 border-l-[var(--color-accent-gold)] shadow-md">
          <div className="flex flex-col gap-2">
            ...
            <p className="font-serif-editorial text-xl sm:text-2xl text-slate-900 italic">
              &ldquo;{album.teaserMessage}&rdquo;
            </p>
          </div>
          <span className="text-xs uppercase tracking-widest text-[var(--color-accent-gold)] font-mono whitespace-nowrap bg-[var(--color-accent-gold)]/10 px-4 py-2 rounded-full border border-[var(--color-accent-gold)]/30 font-semibold">
            PRÓXIMAMENTE
          </span>
        </div>
      </div>
