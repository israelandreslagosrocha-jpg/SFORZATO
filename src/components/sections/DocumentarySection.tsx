  ...
  return (
    <SectionContainer id="produccion" className="py-24 sm:py-32 border-t border-black/5 relative">
      <div className="max-w-5xl mx-auto flex flex-col gap-10 sm:gap-12">
        {/* Tarjetas Informativas Originales */}
        ...
        {/* Carrusel Editorial de Estudio: Inicia siempre con la batería y permite recorrer las 10 capturas */}
        <StudioPhotoCarousel items={studioAssets.allCaptures} />
      </div>
    </SectionContainer>
  );
};
