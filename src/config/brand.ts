...
export const brandConfig: BrandConfig = {
  ...
  logoAsset: {
    path: '/assets/brand/sforzato-music-logo-512.webp', // Asset web optimizado (11.57 KB - 95.76% reducción)
  ...
  heroProvisionalAsset: {
    path: '/assets/brand/hero-image-provisional-ai.webp', // Asset gráfico provisional de preproducción (28.36 KB)
    alt: 'Ambiente estético de estudio de grabación (Asset provisional de preproducción)',
    isProvisional: true,
    status: 'CONFIRMADO',
  },
  coverProvisionalAsset: {
    path: '/assets/brand/en-tu-memoria-cover-provisional-ai.webp', // Arte conceptual promocional provisional de portada (53.24 KB)
